...
<c:choose> <%-- It is Switch Statement --%>
	<c:when test="${!empty countriesList}"> <%-- It is If Condition --%>
		<table border="1" bgcolor="cyan" align="center">
			<tr>
				<th>Country Names</th>
			</tr>
			<c:forEach var="list" items="${countriesList}"> <%-- It is ForEach(Enhanced ForLoop) Condition --%>
				<tr>
					<td>${list}</td>
				</tr>
			</c:forEach>
...
<br>
<h2 style="color: green;text-align: center;"><a href="welcome.do">Home</a></h2>